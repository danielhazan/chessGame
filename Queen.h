...
#ifndef CPPEX2NEW_QUEEN_H
#define CPPEX2NEW_QUEEN_H


/**
 * class Queen defines the fields and methods for the Queen piece on chessboard
 * */
class Queen : public Piece //Soldier hides Piece
{
public:
    /**
    ...
    * @param IsKing T/F
    */
    Queen(int xLoc, int yLoc, string color, bool IsKing = false);
